# Supplemental Knowledge Entries

> See README.md for how to add entries
...
Studio operational clarifications:
- Studio sizes should be treated as approximate, not fixed capacity indicators
- Capacity varies significantly by activity type (e.g., ballroom vs K-pop)
- Studios are rentable from early morning to late midnight, no hard time restrictions
- All studios have wall-to-wall uninterrupted high mirrors
- Controllable lighting suitable for classes, filming, photography, parties
- Free Wi-Fi throughout premises
- Projector + screen available in Studio A and Studio D
- Studios are highly customizable (layout, setup, schedule) upon discussion

### Notes

Clarifications provided during initial knowledge base creation. Emphasizes flexibility over rigid rules.

---

## S-2026-01-29-02

**Related Sections:** Usage Rules, Escalation
**Status:** Confirmed
**Type:** Addition

### Content

**Activity Constraints (High-Impact Activities Restricted)**

The following activity characteristics require extra scrutiny or are generally avoided:
- High-impact jumping
- Falling / rolling techniques
- Contact-based or aggressive movement
- Activities with uncontrolled momentum toward mirrors

Examples to avoid:
- Martial arts (even "non-contact" forms with falls)
- Combat sports
- Parkour-style training
- Stunt rehearsals involving falls

**Reasoning:**
- Studios feature wall-to-wall high mirrors
- Risk of mirror breakage and injury
- Floor surface optimized for dance & fitness, not impact training

**AI Guidance:** If inquiry includes words like sparring, falls, throws, combat, impact → escalate to manual review or polite redirection.

### Notes

Critical safety information. Should be integrated into usage-rules.md during next review.

---

## S-2026-01-29-03

**Related Sections:** Location, Usage Rules
**Status:** Confirmed
**Type:** Clarification

### Content

**Accessibility & Senior Participants**

Physical access reality:
- Studio is located on 2nd floor
- No lift available

Implications:
- Activities designed specifically for mobility-restricted seniors may not be suitable
- However, elderly participants with good mobility (e.g., social dancers) are fully accommodated

**Allowed:**
- Social ballroom dancing
- Latin dance
- Gentle movement classes
- Dance-based fitness for active seniors

**Avoid marketing as:**
- Medical rehabilitation
- Assisted mobility programs
- Frail senior care activities

**AI Guidance:** Use wording like: "Suitable for active adults and seniors with independent mobility."

### Notes

Important for qualifying inquiries involving seniors or accessibility questions.

---

## S-2026-01-29-04

**Related Sections:** Usage Rules, Booking
**Status:** Confirmed
**Type:** Clarification
...
Status: Conditional / Case-by-Case

Reasons:
- Liability considerations
- Activity intensity varies greatly
- Instructor qualification matters

**Allowed with conditions:**
- Gentle prenatal yoga
- Low-impact postnatal movement
- Instructor-led sessions with experience

**AI Guidance:** Do not advertise proactively. If asked, respond: "We can consider this depending on instructor credentials and class format. Let's discuss."

### Notes

Requires human review for all prenatal/postnatal inquiries.

---

## S-2026-01-29-05

**Related Sections:** Usage Rules
**Status:** Confirmed
**Type:** Addition

### Content

**Hair, Makeup & Beauty Classes**

Status: Fully Allowed

Reasons:
- Abundant wall-to-wall mirrors
- Chairs can be provided
- Neutral, clean studio environment

**Suitable for:**
- Makeup masterclasses
- Hairstyling workshops
- Beauty training sessions
- Portfolio prep classes

**Note:** Activities must not involve permanent staining or damage to mirrors or flooring.

### Notes

Expands acceptable use cases beyond movement-only activities.

---

## S-2026-01-29-06

**Related Sections:** Booking, Escalation
**Status:** Confirmed
**Type:** Clarification

### Content

**Corporate Activities — Brand Separation Rule**

**Dance Connexions (Allowed):**
- Team-building (movement-based)
- Wellness programs
- Leadership presence training
- Ice-breaker movement sessions
- Creative collaboration workshops

**Redirect to Reflections Event Space:**
- Classroom-style training
- Theatre-style seminars
- Sit-down corporate meetings
- Formal conferences

**AI Routing Rule:**
- If inquiry mentions "tables, rows, lectures, conference" → Suggest Reflections Event Space
- If inquiry mentions "movement, engagement, activity" → Consider Dance Connexions

### Notes

Reflections Event Space is a separate brand at the same location. Important for routing inquiries correctly.

---

## S-2026-01-29-07

**Related Sections:** Usage Rules, Rooms
**Status:** Confirmed
**Type:** Clarification

### Content

**Photo & Video Shoots — Mirror Management**

Reality:
- At least 3 walls are mirrors
- Mirrors may cause reflections in shoots

**Mitigation options:**
- Temporary mirror covering (discussion required)
- Creative angle planning
- Selective room usage
...
**AI Guidance:** Mention mirrors upfront and offer solutions: "Mirrors are present but we can discuss covering or creative setup."

### Notes

Proactive disclosure prevents shoot-day surprises.
...
- On-site storerooms
- Can be allocated after discussion

**Ideal for:**
- Weekly instructors
- Long-term renters
- Annual prepaid renters
- Equipment-heavy activities

**Value proposition:**
- Reduces renter workload
- Encourages loyalty
- Enables better rates

### Notes

Competitive advantage for securing long-term rentals. Not publicly advertised.
...
**Brand Neutrality & Customization**

Key feature:
- Studios are brand-neutral
- No prominent Dance Connexions branding inside rooms
...
Selling point for content creators and corporate clients.
...
**Pricing Flexibility (Internal Knowledge)**

Public rates: Starting rates shown on website

Reality: Highly flexible pricing

**Discounts available for:**
- Multi-hour bookings
- Multi-day rentals
- Weekly recurring rentals
- Long-term commitments
- Annual upfront payment

**Example:**
- Room A public: RM120/hr
- Long-term renter: RM80/hr or less

**AI Guidance:** Never lock pricing rigidly. Use language: "Rates can be adjusted based on duration and frequency."

### Notes

Internal knowledge only. Do not disclose specific discount amounts publicly.

---

## S-2026-01-29-11

**Related Sections:** Pricing, Escalation
**Status:** Confirmed
**Type:** Clarification
...
Philosophy: Policies are activity-dependent, not rigid.

**Flexible policies for:**
- Walk-in style rentals
- No setup required
...
- High admin workload bookings

**Official positioning:** "We have flexible and accommodating cancellation policies. Once we understand your activity and setup needs, we'll advise the most suitable policy."
